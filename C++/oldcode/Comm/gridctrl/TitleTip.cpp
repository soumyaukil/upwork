                     ...
                     COLORREF crBackClr /* CLR_DEFAULT */)
{
	...
	CRect rectParent;							//Tom add
	m_pParentWnd->GetClientRect(rectParent);	//Tom add
	m_pParentWnd->ClientToScreen(rectParent);	//Tom add

    if (( rectDisplay.right > rectTitle.right-xoffset )||(rectDisplay.right>rectParent.right)) 
    {
		// Show the titletip
