// MDVersion.cpp: implementation of the CMDVersion class.
//
//////////////////////////////////////////////////////////////////////
...
//
BOOL CMDVersion::GetFileVersionInfo(LPCTSTR modulename)
{
...
//
CString CMDVersion::GetValue(LPCTSTR lpKeyName)
{
   CString sVal;
   if (m_pVersionInfo) {
...
//
BOOL CMDVersion::DllGetVersion(LPCTSTR modulename, DLLVERSIONINFO& dvi)
{
